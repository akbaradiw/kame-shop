...
const CartComp = () => {
  ...
  const Checkout = () => {
    ...
    Swal.fire({
      icon: "success",
      title: "Purchase Item Successfully",
      showConfirmButton: false,
      timer: 1500,
    }).then (() => {
      navigate("/")
      ...
      <div className="lg:py-10 lg:ps-20">
        <div className="  border-y border-emerald-600 h-40 w-60">
          ...
          <div className="text-center">
            <button
              onClick={() => Checkout()}
              className="bg-blue-600 hover:bg-yellow-300 text-sm font-semibold hover:text-emerald-600 text-zinc-100 p-2 rounded-md w-full md:w-auto"
            >
              Purchase
            </button>
          </div>
